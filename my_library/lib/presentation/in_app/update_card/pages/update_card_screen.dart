...
class UpdateCardScreen extends GetView<UpdateCardController> {
  MyCard myCard = Get.arguments;
  @override
  Widget build(BuildContext context) {
    controller.myCard = myCard;
    return Scaffold(
      body: Obx(
        () => Stack(children: [
          GestureDetector(
                          ...
                          child: Column(
                            ...
                            children: [
                              Card(
                                ...
                                elevation: 4,
                                child: TextFormField(
                                  initialValue: controller.myCard.title!.value,
                                  enabled: !controller.isImageClicked.value,
                                  onSaved: (title) {
                                    controller.myCard.title!.value = title!;
                                  },
                              ...
                              Card(
                                ...
                                child: TextFormField(
                                  initialValue:
                                      controller.myCard.shortExp!.value,
                                  enabled: !controller.isImageClicked.value,
                                  onSaved: (shortExp) {
                                    controller.myCard.shortExp!.value =
                                        shortExp!;
                              ...
                              SizedBox(
                                ...
                                child: Card(
                                  ...
                                  child: TextFormField(
                                    initialValue:
                                        controller.myCard.longExp!.value,
                                    enabled: !controller.isImageClicked.value,
                                    onSaved: (longExp) {
                                      controller.myCard.longExp!.value =
                                          longExp!;
