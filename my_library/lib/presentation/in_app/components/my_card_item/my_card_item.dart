  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Obx(
        () => ListTile(
          onTap: () {
            myCard.isFetched ? null : myCard.fetchFiles();
            myCard.isFetched = true;
            Get.toNamed(Routes.CARD_DETAIL_SCREEN_ROUTE, arguments: myCard);
          },
          leading: myCardController.fireImageFileList.isNotEmpty
              ? CircleAvatar(
                  backgroundImage:
                      myCardController.fireImageFileList.first.image.image,
